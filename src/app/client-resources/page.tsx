    ...
    <>
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/marki-luna-lake.webp" alt="Okanagan Lake view — Kelowna BC real estate by Marki Hoffman" fill className="object-cover object-top" sizes="100vw" priority />
